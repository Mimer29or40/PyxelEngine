...
import PyxelEngine
from PyxelEngine.callbacks import error_callback
from PyxelEngine.callbacks import monitor_callback
from PyxelEngine.math import Vector2
from PyxelEngine.math import Vector2Like
from PyxelEngine.monitor import Monitor
...
class _Window:
    def __init__(
        ...
        self.monitor: Monitor = Monitor.primary() if monitor is None else monitor
