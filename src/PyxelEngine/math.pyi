...
class Vector3(Vector3c, np.ndarray):
    @overload
    def __init__(self, x: DType, y: DType, z: DType, dtype: Type[DType] = float) -> Vector3: ...
    @overload
    def __init__(self, xy: Vector2c, z: DType, dtype: Type[DType] = float) -> Vector3: ...
    @overload
...
class Vector4(Vector4c, np.ndarray):
    @overload
    def __init__(self, x: DType, y: DType, z: DType, w: DType, dtype: Type[DType] = float) -> Vector4: ...
    @overload
    def __init__(self, xyz: Vector3c, w: DType, dtype: Type[DType] = float) -> Vector4: ...
    @overload
    def __init__(self, xy: Vector2c, zw: Vector2c, dtype: Type[DType] = float) -> Vector4: ...
    @overload
    ...
    @overload
    def __init__(self, xyzw: Iterable[DType], dtype: Type[DType] = float) -> Vector4: ...
    @overload
